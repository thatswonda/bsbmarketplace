      ...
      <div className="hidden md:grid grid-cols-4 gap-8 mb-10">
        ...
        <div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <a href="https://play.google.com/store/apps/details?id=com.austindev.bsb&pcampaignid=web_share" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2.5 bg-foreground text-card rounded-lg text-sm font-medium hover:opacity-90 transition-opacity w-fit">
