...
const DownloadSection = () => (
  <section className="py-16 sm:py-24 bg-card" id="about-us">
    <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
      <motion.div
        initial={{ opacity: 0, y: 16 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        className="bg-primary rounded-[20px] sm:rounded-[24px] p-8 sm:p-16"
      >
        <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-primary-foreground mb-3 sm:mb-4">
          Download App
        </h2>
        <p className="text-primary-foreground/80 mb-6 sm:mb-8 max-w-md mx-auto text-sm sm:text-base">
          Get our mobile app to access exclusive offers and deals.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-4 sm:mb-0">
          <a
            href="#"
            className="inline-flex items-center gap-3 px-5 sm:px-6 py-2.5 sm:py-3 bg-foreground text-card rounded-xl font-medium hover:opacity-90 transition-opacity w-full sm:w-auto justify-center"
          >
            ...
            <div className="text-left">
              ...
              <div className="text-xs sm:text-sm font-semibold -mt-0.5">App Store</div>
            </div>
          </a>
          <a
            href="#"
        ...
        <div className="mt-4 sm:hidden">
          <a
            href="#"
            className="inline-flex items-center justify-center gap-2 w-full py-3 bg-accent text-primary font-semibold rounded-xl text-sm hover:opacity-90 transition-opacity"
          >
            Download App
