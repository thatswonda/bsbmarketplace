...
import ctaImg from "@/assets/cta-desktop.jpg";
  ...
  <section className="py-6 sm:py-24 bg-card">
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
      ...
      <div className="hidden md:block relative rounded-3xl overflow-hidden" style={{ boxShadow: "var(--card-shadow-hover)" }}>
        <img src={ctaImg} alt="Join BSB Market" className="w-full h-[400px] object-cover" loading="lazy" width={1280} height={720} />
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="px-12 max-w-lg">
            ...
            >
              <a href="#" className="inline-flex items-center gap-2 px-6 py-3 bg-primary text-primary-foreground rounded-xl font-medium hover:opacity-90 transition-opacity">
              ...
              <a href="#" className="inline-flex items-center gap-2 px-6 py-3 bg-primary-foreground text-foreground rounded-xl font-medium hover:opacity-90 transition-opacity">
      ...
      >
        ...
        <div className="flex items-center justify-center gap-2">
          <a href="#" className="inline-flex items-center gap-1.5 px-3 py-2 bg-foreground text-card rounded-lg text-xs font-medium hover:opacity-90 transition-opacity">
          ...
          <a href="#" className="inline-flex items-center gap-1.5 px-3 py-2 bg-primary-foreground text-foreground rounded-lg text-xs font-medium hover:opacity-90 transition-opacity">
